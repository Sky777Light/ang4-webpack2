THREE.OrbitControls = function ( object, domElement ) {
    ...
    this.update = function() {
        ...
        return function () {
            ...
            spherical.radius = Math.max( scope.minDistance, Math.min( scope.maxDistance, radius || spherical.radius ) );
    ...
    this.updateDevice = function () {
        ...
        return function () {
            ...
            rotateUp(lastBeta - currentAngle.y, true);
            rotateLeft(lastGamma - currentAngle.z, true);
    ...
    function rotateLeft( angle, device ) {

        if (scope.inverse && device !== true) {
    ...
    function rotateUp( angle, device ) {
